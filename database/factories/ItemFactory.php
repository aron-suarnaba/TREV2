...
class ItemFactory extends Factory
{
    ...
    public function definition(): array
    {
        ...
        return [
            ...
            'invoice_total' => fake()->randomFloat(2, 1, 10000),
            'non_vat_sales' => fake()->randomFloat(2, 0, 10000),
            'exempt_sales' => fake()->randomFloat(2, 0, 10000),
            'vat_amount' => fake()->randomFloat(2, 0, 2000),
            'account_code' => fake()->numerify('#####'),
            'acctu3' => fake()->numerify('###'),
            'acctu4' => fake()->numerify('###'),
            'vat_class' => fake()->randomElement(['V', 'N']),
            'remarks' => fake()->optional()->sentence(),
            'is_for_approval' => fake()->boolean(),
            'del_charge' => fake()->randomFloat(2, 0, 2000),
            'scpwd_basis' => fake()->randomFloat(2, 0, 1000),
            'scpwd_disc' => fake()->randomFloat(2, 0, 500),
        ];
    }
}
